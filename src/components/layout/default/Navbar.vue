  ...
  <div class="sticky top-0 z-40">
    <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
      ...
      <div class="flex items-center relative">
        ...
        <img src="../../../assets/img/jariel400x400.jpg" class="w-12 h-12 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
      </div>
    ...
    <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 bottom-10 right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
      <a href="#" class="block px-4 py-2 hover:bg-gray-200">Minha conta</a>
      <a href="#" class="block px-4 py-2 hover:bg-gray-200">Configurações</a>
      <a href="#" class="block px-4 py-2 hover:bg-gray-200">Sair do sistema</a>
    </div>
    <!-- dropdown menu end -->
